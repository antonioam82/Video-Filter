...
def frames_editor(args):
    ...
    try:
        ...
        print(f"USED PARAMS: [PixDiam:{args.pixel_diameter}|SigCol:{args.sigma_color}|SigSpc:{args.sigma_space}|Contrast:{args.contrast}|Brightness:{args.brightness}]\n")
...
def add_contrast(fr,g,b):
    result = cv.convertScaleAbs(fr, alpha=g, beta=b)
    return result
...
def app(args):
    ...
    print(Fore.BLACK + Back.GREEN + "\n B I L A T E R A L  V I D E O   F I L T E R   2.1 \n" + Fore.RESET + Back.RESET)
...
def main():
    ...
    parser = argparse.ArgumentParser(prog="bvf 2.1", description="Bilateral video filter on CLI", epilog='REPO: https://github.com/antonioam82/Video-Filter')
